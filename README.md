...
## Step 7: Alerting and tickets

The alert-and-ticket agent sends a Slack alert and creates one ticket for each recent summarized open incident that has not been ticketed. Run it locally with:

```bash
npm run alert-and-ticket
```
